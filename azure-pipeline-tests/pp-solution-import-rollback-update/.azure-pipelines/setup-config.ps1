return @{
    ...
    Pipelines                       = @(
        @{
            Name         = "(TEST CI) 00 No rollback patch import - prepare";
            Path         = "/azure-pipeline-tests/pp-solution-import-rollback-update/.azure-pipelines/00-prepare-test-environment.yml";
            PipelinePath = "pipeline-tests/pp-solution-import-rollback-update"
        },
        @{
            Name         = "(TEST CI) 01 No rollback patch import - import";
            Path         = "/azure-pipeline-tests/pp-solution-import-rollback-update/.azure-pipelines/01-import-solutions.yml";
            PipelinePath = "pipeline-tests/pp-solution-import-rollback-update"
        },
        @{
            Name         = "(TEST CI) 02 No rollback patch import - check";
            Path         = "/azure-pipeline-tests/pp-solution-import-rollback-update/.azure-pipelines/02-check-solutions.yml";
            PipelinePath = "pipeline-tests/pp-solution-import-rollback-update"
        }
    );
