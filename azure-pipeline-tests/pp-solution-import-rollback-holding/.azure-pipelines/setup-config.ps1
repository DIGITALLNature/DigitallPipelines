return @{
    ...
    Pipelines                       = @(
        @{
            Name         = "(TEST CI) 00 Rollback holding import - prepare";
            Path         = "/azure-pipeline-tests/pp-solution-import-rollback-holding/.azure-pipelines/00-prepare-test-environment.yml";
            PipelinePath = "pipeline-tests/pp-solution-import-rollback-holding"
        },
        @{
            Name         = "(TEST CI) 01 Rollback holding import - import";
            Path         = "/azure-pipeline-tests/pp-solution-import-rollback-holding/.azure-pipelines/01-import-solutions.yml";
            PipelinePath = "pipeline-tests/pp-solution-import-rollback-holding"
        },
        @{
            Name         = "(TEST CI) 02 Rollback holding import - check";
            Path         = "/azure-pipeline-tests/pp-solution-import-rollback-holding/.azure-pipelines/02-check-solutions.yml";
            PipelinePath = "pipeline-tests/pp-solution-import-rollback-holding"
        }
    );
